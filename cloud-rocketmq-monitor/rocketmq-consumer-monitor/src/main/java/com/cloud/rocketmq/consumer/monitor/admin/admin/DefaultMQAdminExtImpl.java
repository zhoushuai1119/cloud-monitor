 ...
 */
package com.cloud.rocketmq.consumer.monitor.admin.admin;

import com.cloud.rocketmq.consumer.monitor.admin.admin.api.MessageTrack;
import com.cloud.rocketmq.consumer.monitor.admin.admin.api.TrackType;
...
public class DefaultMQAdminExtImpl implements MQAdminExt, MQAdminExtInner {
    ...
    public void createAndUpdateTopicConfig(String addr, TopicConfig config) throws RemotingException, MQBrokerException,
        ...
        this.mqClientInstance.getMQClientAPIImpl().createTopic(addr, "TBW102", config, timeoutMillis);
    }
    ...
    public void deleteTopicInNameServer(Set<String> addrs,
        ...
        for (String addr : addrs) {
            this.mqClientInstance.getMQClientAPIImpl().deleteTopicInNameServer(addr, topic, null,timeoutMillis);
        }
    }
